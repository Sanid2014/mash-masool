    ...
    <div style={S.global}>
      ...
      {(currentUser || isAdmin) && (() => {
        ...
        const tabIcons = {
          ...
          games:    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M6 12h4M8 10v4"/><circle cx="15" cy="11" r="1" fill="currentColor"/><circle cx="17" cy="13" r="1" fill="currentColor"/><path d="M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v.5c0 .3.1.6.3.8l.4.5a2 2 0 0 1 .3 1v.2a3 3 0 0 1-3 3h-.1a3 3 0 0 1-2.4-1.2l-.4-.5a1 1 0 0 0-.8-.4H8.7a1 1 0 0 0-.8.4l-.4.5A3 3 0 0 1 5.1 14H5a3 3 0 0 1-3-3v-.2a2 2 0 0 1 .3-1l.4-.5c.2-.2.3-.5.3-.8V9z"/></svg>,
