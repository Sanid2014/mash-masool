    ...
    <div style={S.global}>
      ...
      {(currentUser || isAdmin) && (() => {
        ...
        const tabIcons = {
          ...
          games:    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M2 6h20v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V6z"/><path d="M8 6V4"/><path d="M16 6V4"/><line x1="7" y1="11" x2="11" y2="11"/><line x1="9" y1="9" x2="9" y2="13"/><circle cx="15" cy="10" r="1" fill="currentColor" stroke="none"/><circle cx="17" cy="12" r="1" fill="currentColor" stroke="none"/></svg>,
