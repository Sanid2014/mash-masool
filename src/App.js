    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 9800, background: "#000", direction: dir }} onClick={goNext}>
      ...
      <div style={{ position: "absolute", top: 24, left: 0, right: 0, zIndex: 10, display: "flex", alignItems: "center", gap: 10, padding: "8px 14px" }} onClick={e => e.stopPropagation()}>
        ...
        {isMyStory && (
          ...
          >
            <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"/></svg> {lang === "ar" ? "حذف" : "Delete"}
          </button>
        )}
                    ...
                    {data.topPerformers.map(p => (
                      <div key={p.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: `1px solid ${theme.border}`, flexWrap: "wrap", gap: 6 }}>
                        ...
                        <div style={{ display: "flex", gap: 6 }}>
                          ...
                          <button onClick={() => setData(d => { const updated = d.topPerformers.filter(x => x.id !== p.id); savePerformers(updated, d.performerMonth, d.performerMonthKey); return { ...d, topPerformers: updated }; })} style={{ ...S.btn, ...S.ghost, padding: "3px 10px", fontSize: 12, color: "#e74c3c", display:"flex", alignItems:"center", gap:4 }}><svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor"><path d="M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"/></svg>{t("deleteBtn")}</button>
                        </div>
                      </div>
                    ))}
                  </div>
                        ...
                        {editingUser === u.id ? (
                          ...
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
                            ...
                            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                              ...
                              <button onClick={() => { setEditingUser(u.id); setEditUserForm({ name: u.name, password: "", role: u.role || "member", moderatorPerms: u.moderatorPerms || DEFAULT_MOD_PERMS }); }} style={{ ...S.btn, ...S.ghost, padding: "3px 10px", fontSize: 12, color: theme.accent, display:"flex", alignItems:"center", gap:4 }}><svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor"><path d="M16.4356 3.21188C16.8261 2.82185 17.4592 2.82157 17.8496 3.21188L20.6777 6.04099C21.0681 6.43152 21.0682 7.06457 20.6777 7.45505L7.2422 20.8896H3.00001V16.6475L16.4356 3.21188ZM5.00001 17.4756V18.8896H6.41407L15.7276 9.57615L14.3135 8.16208L5.00001 17.4756ZM4.5293 1.3193C4.70583 0.893505 5.29418 0.893508 5.47071 1.3193L5.72364 1.93063C6.15555 2.97342 6.96155 3.80613 7.97462 4.2568L8.69239 4.57614C9.10267 4.75896 9.10262 5.35616 8.69239 5.53903L7.93263 5.87692C6.94497 6.3162 6.15339 7.11943 5.71387 8.1279L5.4668 8.69334C5.28636 9.10747 4.71366 9.10747 4.53321 8.69334L4.28614 8.1279C3.84661 7.11943 3.05506 6.3162 2.06739 5.87692L1.30762 5.53903C0.897483 5.35617 0.897435 4.75896 1.30762 4.57614L2.0254 4.2568C3.03845 3.80614 3.84446 2.97344 4.27637 1.93063L4.5293 1.3193ZM15.7276 6.74802L17.1426 8.16208L18.5567 6.74802L17.1426 5.33395L15.7276 6.74802Z"/></svg>{t("editBtn")}</button>
                              ...
                              {isAdmin && <button onClick={() => deleteUser(u.id)} style={{ ...S.btn, ...S.ghost, padding: "3px 10px", fontSize: 12, color: "#e74c3c", display:"flex", alignItems:"center", gap:4 }}><svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor"><path d="M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"/></svg>{t("deleteBtn")}</button>}
                            </div>
                          </div>
                        )}
                      </div>
              ...
              <div style={{ padding: "16px 24px 20px", direction: dir, flexShrink: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 18 }}>
                  ...
                  <div style={{ position: "relative", flexShrink: 0 }}>
                    ...
                    <div onClick={() => document.getElementById("mp-avatar-input").click()} style={{ position: "absolute", bottom: 0, right: 0, width: 24, height: 24, borderRadius: "50%", background: theme.accent, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", border: `2px solid ${theme.card}` }}>
                      <svg viewBox="0 0 24 24" width="13" height="13" fill="#fff"><path d="M16.4356 3.21188C16.8261 2.82185 17.4592 2.82157 17.8496 3.21188L20.6777 6.04099C21.0681 6.43152 21.0682 7.06457 20.6777 7.45505L7.2422 20.8896H3.00001V16.6475L16.4356 3.21188ZM5.00001 17.4756V18.8896H6.41407L15.7276 9.57615L14.3135 8.16208L5.00001 17.4756ZM4.5293 1.3193C4.70583 0.893505 5.29418 0.893508 5.47071 1.3193L5.72364 1.93063C6.15555 2.97342 6.96155 3.80613 7.97462 4.2568L8.69239 4.57614C9.10267 4.75896 9.10262 5.35616 8.69239 5.53903L7.93263 5.87692C6.94497 6.3162 6.15339 7.11943 5.71387 8.1279L5.4668 8.69334C5.28636 9.10747 4.71366 9.10747 4.53321 8.69334L4.28614 8.1279C3.84661 7.11943 3.05506 6.3162 2.06739 5.87692L1.30762 5.53903C0.897483 5.35617 0.897435 4.75896 1.30762 4.57614L2.0254 4.2568C3.03845 3.80614 3.84446 2.97344 4.27637 1.93063L4.5293 1.3193ZM15.7276 6.74802L17.1426 8.16208L18.5567 6.74802L17.1426 5.33395L15.7276 6.74802Z"/></svg>
                    </div>
        ...
        <div style={{ position:"fixed",inset:0,zIndex:9999,background:"rgba(0,0,0,0.6)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,direction:dir }} onClick={() => setNaifConfirm(null)}>
          <div style={{ background: darkMode?"#1a1030":"#fff",borderRadius:20,padding:"28px 24px",maxWidth:360,width:"100%",boxShadow:"0 24px 64px rgba(0,0,0,0.4)",border:`1px solid ${darkMode?"rgba(168,130,255,0.2)":"rgba(155,89,182,0.15)"}` }} onClick={e=>e.stopPropagation()}>
            <div style={{ fontSize:36,textAlign:"center",marginBottom:12 }}>
              {naifConfirm.type==="delete" ? "🗑" : <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M16.4356 3.21188C16.8261 2.82185 17.4592 2.82157 17.8496 3.21188L20.6777 6.04099C21.0681 6.43152 21.0682 7.06457 20.6777 7.45505L7.2422 20.8896H3.00001V16.6475L16.4356 3.21188ZM5.00001 17.4756V18.8896H6.41407L15.7276 9.57615L14.3135 8.16208L5.00001 17.4756ZM4.5293 1.3193C4.70583 0.893505 5.29418 0.893508 5.47071 1.3193L5.72364 1.93063C6.15555 2.97342 6.96155 3.80613 7.97462 4.2568L8.69239 4.57614C9.10267 4.75896 9.10262 5.35616 8.69239 5.53903L7.93263 5.87692C6.94497 6.3162 6.15339 7.11943 5.71387 8.1279L5.4668 8.69334C5.28636 9.10747 4.71366 9.10747 4.53321 8.69334L4.28614 8.1279C3.84661 7.11943 3.05506 6.3162 2.06739 5.87692L1.30762 5.53903C0.897483 5.35617 0.897435 4.75896 1.30762 4.57614L2.0254 4.2568C3.03845 3.80614 3.84446 2.97344 4.27637 1.93063L4.5293 1.3193ZM15.7276 6.74802L17.1426 8.16208L18.5567 6.74802L17.1426 5.33395L15.7276 6.74802Z"/></svg>}
            </div>
          ...
          {showNaifWrite && (
            <div style={{ position:"absolute",inset:0,zIndex:25,display:"flex",flexDirection:"column",background: darkMode?"#0d0820":"#f3eeff",direction:dir,animation:"sheetUp 0.28s cubic-bezier(0.32,0.72,0,1)" }}>
              ...
              <div style={{ flexShrink:0,padding:"calc(env(safe-area-inset-top,0px) + 14px) 20px 14px",background: darkMode?"linear-gradient(135deg,#1a0533,#0d1a3a)":"linear-gradient(135deg,#7c3aed,#4f46e5)",display:"flex",alignItems:"center",gap:12,boxShadow:"0 4px 24px rgba(0,0,0,0.4)" }}>
                ...
                <div style={{ flex:1,color:"#fff",fontWeight:900,fontSize:17,display:"flex",alignItems:"center",gap:7 }}>{editingNaifId ? <><svg viewBox="0 0 24 24" width="18" height="18" fill="#fff"><path d="M16.4356 3.21188C16.8261 2.82185 17.4592 2.82157 17.8496 3.21188L20.6777 6.04099C21.0681 6.43152 21.0682 7.06457 20.6777 7.45505L7.2422 20.8896H3.00001V16.6475L16.4356 3.21188ZM5.00001 17.4756V18.8896H6.41407L15.7276 9.57615L14.3135 8.16208L5.00001 17.4756ZM4.5293 1.3193C4.70583 0.893505 5.29418 0.893508 5.47071 1.3193L5.72364 1.93063C6.15555 2.97342 6.96155 3.80613 7.97462 4.2568L8.69239 4.57614C9.10267 4.75896 9.10262 5.35616 8.69239 5.53903L7.93263 5.87692C6.94497 6.3162 6.15339 7.11943 5.71387 8.1279L5.4668 8.69334C5.28636 9.10747 4.71366 9.10747 4.53321 8.69334L4.28614 8.1279C3.84661 7.11943 3.05506 6.3162 2.06739 5.87692L1.30762 5.53903C0.897483 5.35617 0.897435 4.75896 1.30762 4.57614L2.0254 4.2568C3.03845 3.80614 3.84446 2.97344 4.27637 1.93063L4.5293 1.3193ZM15.7276 6.74802L17.1426 8.16208L18.5567 6.74802L17.1426 5.33395L15.7276 6.74802Z"/></svg> تعديل المذكرة</> : "✍️ مذكرة جديدة"}</div>
                <button
                  onClick={() => {
                    if (!newNaifTitle.trim() || !newNaifContent.trim()) return;
                    if (editingNaifId) {
